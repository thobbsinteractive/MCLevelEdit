...
public static class EntityViewModelToEntity
{
    public static Entity ToEntity(this EntityViewModel entityView)
    {
        ...
        return new Entity() { Id = entityView.Id, EntityType = entityType, Position = new Position(entityView.X, entityView.Y), DisId = entityView.DisId, SwitchSize = entityView.SwitchSize, SwitchId = entityView.SwitchId, Parent = entityView.Parent, Child = entityView.Child };
    }
}
